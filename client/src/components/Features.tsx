    ...
    return (
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    title="Features"
                    heading="Build for modern brands and businesses"
                    description="Our AI instantly produces professional lifestyle imagery and short form video content, empowering brands to create and scale their visual content effortlessly."
                />
