...
import { trustedUserImages, galleryStripImages, trustedLogosText, mainImageUrl } from '../utils/index.ts';
                        ...
                        <div className="text-left">
                            ...
                            >
                                ...
                                <span className="text-xs text-gray-200/90">
                                    Trusted by 10,000+ creators, startups and businesses worldwide
                                </span>
                            </motion.a>
                            ...
                            >
                                Upload product images and a model photo - our UI instantly creates a stunning professional imagery and short-form vidoes for your brand, ready to share and convert.
                            </motion.p>
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-white/3 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-400">
                                            Use for ads, social media and more
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            <motion.div className="rounded-3xl overflow-hidden border border-white/6 shadow-2xl bg-linear-to-b from-black/50 to-transparent">
                                <div className="relative aspect-16/10 bg-gray-900">
                                    ...
                                    <div className="absolute left-4 top-4 px-3 py-1 rounded-full bg-black/15 backdrop-blur-sm text-xs">
                                        Social-ready • 9:16 & 16:9 formats
                                    </div>
                ...
                <div className="max-w-6xl mx-auto px-6">
                    <div className="w-full overflow-hidden py-6">
                        ...
                        {trustedLogosText.concat(trustedLogosText).map((logo, i) => (
                            <div
                            key={i}
                            className="flex items-center gap-3 mx-6 text-sm md:text-base font-semibold text-gray-400 hover:text-gray-300 transition-colors"
                            >
                            <i className={`${logo.icon} text-2xl`} />
                            <span className="tracking-wide">{logo.name}</span>
                            </div>
                        ))}
                        </div>
                    </div>
