...
export const createVideo = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const prompt = `make the person showcase the product which is ${project.productName} ${project.productDescription && `and Project Description: ${project.productDescription}`}`
        ...
        // Create image directory if it dosn't exist 
